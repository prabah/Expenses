...
namespace ExpenseTracker.Repository
{
    public class ExpenseTrackerEFRepository : ExpenseTracker.Repository.IExpenseTrackerRepository
    {
        ...
        {
            return _ctx.Clients.FirstOrDefault(e => e.Id == id);
        }

        public RepositoryActionResult<Client> InsertClient(Client e)
        {
            try
            {
                _ctx.Clients.Add(e);
                ...
                if (result > 0)
                {
                    return new RepositoryActionResult<Client>(e, RepositoryActionStatus.Created);
                }
                else
                {
                    return new RepositoryActionResult<Client>(e, RepositoryActionStatus.NothingModified, null);
                }
        ...
        public RepositoryActionResult<Client> UpdateClient(Client e)
        {
            try
            {
                ...
                var existingExpense = _ctx.Clients.FirstOrDefault(exp => exp.Id == e.Id);

                if (existingExpense == null)
                {
                    return new RepositoryActionResult<Client>(e, RepositoryActionStatus.NotFound);
                }
                ...
                if (result > 0)
                {
                    return new RepositoryActionResult<Client>(e, RepositoryActionStatus.Updated);
                }
                else
                {
                    return new RepositoryActionResult<Client>(e, RepositoryActionStatus.NothingModified, null);
