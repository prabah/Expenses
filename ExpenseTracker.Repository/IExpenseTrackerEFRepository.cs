...
namespace ExpenseTracker.Repository
{
    public interface IExpenseTrackerRepository
    {
        ...
        System.Linq.IQueryable<ExpenseTracker.Repository.Entities.Client> GetClients();
        ExpenseTracker.Repository.Entities.Client GetClient(int id);
        RepositoryActionResult<ExpenseTracker.Repository.Entities.Client> InsertClient(ExpenseTracker.Repository.Entities.Client e);
        RepositoryActionResult<ExpenseTracker.Repository.Entities.Client> UpdateClient(ExpenseTracker.Repository.Entities.Client e);
    }
}
